...
@MappedSuperclass
public abstract class GenericBeanOld implements Serializable {
	protected static final long serialVersionUID = -2866941365258232556L;
	protected Integer id;

	public GenericBeanOld() {
	}

	public GenericBeanOld(Integer id) {
		this.id = id;
	}
	...
	public boolean equals(Object obj) {
		try {
			return id.equals(((GenericBeanOld) obj).getId());
		} catch (Exception e) {
			return false;
		}
	}
