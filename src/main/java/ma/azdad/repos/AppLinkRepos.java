...
public interface AppLinkRepos extends JpaRepository<AppLink, Integer> {
	...
	String currency = "(select b.paymentterm.po.currency.currency from Acceptance b where a.acceptance.idacceptance = b.idacceptance),(select b.budgetdetail.budget.currency.currency from Expensepayment b where a.expensepayment.idexpensepayment = b.idexpensepayment )";
