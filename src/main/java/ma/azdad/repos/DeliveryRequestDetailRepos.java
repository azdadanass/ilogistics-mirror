...
public interface DeliveryRequestDetailRepos extends JpaRepository<DeliveryRequestDetail, Integer> {
	...
	String c1 = "select new DeliveryRequestDetail(sum(a.quantity), a.status, a.originNumber, a.partNumber.id,a.partNumber.name,a.partNumber.description,a.partNumber.industryName,a.partNumber.categoryName,a.partNumber.typeName,a.partNumber.brandName,a.partNumber.partNumberOrangeName,a.partNumber.partNumberOrangeDescription, a.inboundDeliveryRequest,a.unitCost) ";
	String c2 = "select new DeliveryRequestDetail(sum(a.quantity),a.partNumber.id,a.partNumber.name,a.partNumber.description,a.partNumber.industryName,a.partNumber.categoryName,a.partNumber.typeName,a.partNumber.brandName,a.partNumber.partNumberOrangeName,a.partNumber.partNumberOrangeDescription,a.unitCost) ";
	String c3 = "select new DeliveryRequestDetail(a.id,a.partNumber.id,a.partNumber.name,a.partNumber.description,a.partNumber.industryName,a.partNumber.categoryName,a.partNumber.typeName,a.partNumber.brandName,a.partNumber.partNumberOrangeName,a.partNumber.partNumberOrangeDescription,a.deliveryRequest.id,a.deliveryRequest.type,a.deliveryRequest.reference,a.quantity, "
			+ usedQuantity3 + "," + toUserFullName + ")";
	String c4 = "select new DeliveryRequestDetail(a.id,a.partNumber.id,a.partNumber.name,a.partNumber.description,a.partNumber.industryName,a.partNumber.categoryName,a.partNumber.typeName,a.partNumber.brandName,a.partNumber.partNumberOrangeName,a.partNumber.partNumberOrangeDescription,a.deliveryRequest.id,a.deliveryRequest.type,a.deliveryRequest.reference,a.unitCost,a.deliveryRequest.date4,a.deliveryRequest.project.name) ";
...
//	public Double findPendingQuantityByCustomerOwnerAnPartNumber(String username, List<Integer> warehouseList, List<Integer> assignedProjectList, Integer customerId, Integer partNumberId, DeliveryRequestType deliveryRequestType, List<DeliveryRequestStatus> statusList);
	...
	public List<Object[]> findPendingQuantityByCompanyOwnerGroupByPartNumber(String username, List<Integer> warehouseList, List<Integer> assignedProjectList, Integer companyId,
