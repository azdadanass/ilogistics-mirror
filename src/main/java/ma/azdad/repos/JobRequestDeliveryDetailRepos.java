...
public interface JobRequestDeliveryDetailRepos extends JpaRepository<JobRequestDeliveryDetail, Integer> {
	...
	String select1 = "select new JobRequestDeliveryDetail(a.installedQuantity,a.isSerialNumberRequired,a.deliveryRequestDetail.id,a.deliveryRequestDetail.partNumber.name,a.deliveryRequestDetail.partNumber.description,a.deliveryRequestDetail.deliveryRequest.referenceNumber,a.deliveryRequestDetail.deliveryRequest.type,a.jobRequest.id,a.jobRequest.site.name,a.jobRequest.team.name)";
