...
public interface PartNumberPricingRepos extends JpaRepository<PartNumberPricing, Integer> {
	...
	String c1 = "select new PartNumberPricing(a.id,a.date,a.baseLineCost,a.baseLinePrice,a.maxAllowedDiscount,a.physicalQuantity,a.pendingQuantity,a.countFiles,a.currency.currency," //
