...
public interface StockRowRepos extends JpaRepository<StockRow, Integer> {
	...
	String c2 = "select new StockRow(sum(a.quantity),a.status, a.originNumber, a.partNumber.id,a.partNumber.name,a.partNumber.description,a.partNumber.industryName,a.partNumber.categoryName,a.partNumber.typeName,a.partNumber.brandName,a.partNumber.partNumberOrangeName,a.partNumber.partNumberOrangeDescription, a.inboundDeliveryRequest,a.unitCost,a.location,a.packing) ";
	String c3 = "select new StockRow(sum(a.quantity),a.deliveryRequest,a.status,a.originNumber,a.partNumber.id,a.partNumber.name,a.partNumber.description,a.partNumber.industryName,a.partNumber.categoryName,a.partNumber.typeName,a.partNumber.brandName,a.partNumber.partNumberOrangeName,a.partNumber.partNumberOrangeDescription,a.inboundDeliveryRequest,a.unitCost,a.location)";
	String c4 = "select new StockRow(sum(a.quantity),a.partNumber.id,a.partNumber.name,a.partNumber.description,a.partNumber.industryName,a.partNumber.categoryName,a.partNumber.typeName,a.partNumber.brandName,a.partNumber.partNumberOrangeName,a.partNumber.partNumberOrangeDescription,sum(case when a.quantity > 0 then a.quantity else 0 end),sum(case when a.quantity < 0 then a.quantity else 0 end))";
	String c5 = "select  new StockRow(sum(a.quantity),a.partNumber.id,a.partNumber.name,a.partNumber.description,a.partNumber.industryName,a.partNumber.categoryName,a.partNumber.typeName,a.partNumber.brandName,a.partNumber.partNumberOrangeName,a.partNumber.partNumberOrangeDescription,a.deliveryRequest) ";
	String c6 = " select new StockRow(sum(a.quantity),a.partNumber.id,a.partNumber.name,a.partNumber.description,a.partNumber.industryName,a.partNumber.categoryName,a.partNumber.typeName,a.partNumber.brandName,a.partNumber.partNumberOrangeName,a.partNumber.partNumberOrangeDescription) ";
