...
//		return null;
	...
	public void updateDetailListUnitPriceFromBoqMapping(Integer deliveryRequestId) {
		...
		deliveryRequest.getBoqMappingList().stream()//
				...
				.forEach(i -> boqPriceMap.put(i.getPartNumberEquivalence().getDetailList().get(0).getPartNumber(), i.getBoq().getUnitPrice() / i.getPartNumberEquivalence().getDetailList().get(0).getQuantity()));
