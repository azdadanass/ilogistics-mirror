...
function drawCells(warehouseData) {
	...
	parsed.forEach(item => {
		...
		rect.on('pointerdown', () => {
			...
			initStockRowDetailDatatable([{name:'id', value:`${rect.cellId}`}]);
		});
